...
import { UserPlus, PlusCircle, Eye, Edit } from 'lucide-react';
import { format } from 'date-fns';

import type { StudentApplication, ApplicationStatus } from '@/lib/types';
import { getAdminStudentApplications, updateAdminStudentApplicationStatus } from '@/lib/services/adminService';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const AddApplicationDialog = dynamic(() => import('@/components/admin/admissions/AddApplicationDialog'), {
  ssr: false,
});
