...
export default function StudentTimetablePage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setError(null);
      try {
        const data = await getStudentTimetable(MOCK_STUDENT_ID);
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            ...
                            <TableHead className="w-[35%] text-xs uppercase font-medium text-muted-foreground">Subject</TableHead>
                            <TableHead className="w-[35%] text-xs uppercase font-medium text-muted-foreground">Teacher</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
